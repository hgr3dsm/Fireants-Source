...
These are the dependencies currently used by Fireants. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/fireantsnl
Keybase  - https://keybase.io/team/fireants/
