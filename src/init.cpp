...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/hgr3dsm>";
    const std::string URL_WEBSITE = "<http://fireants.online//>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i-%i The Fireants Developers", 2021, COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Fireants useful. "
