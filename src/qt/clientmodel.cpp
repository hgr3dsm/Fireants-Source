...
void ClientModel::subscribeToCoreSignals()
{
    ...
    uiInterface.NotifyBlockTip.connect(boost::bind(BlockTipChanged, this, boost::arg<1>, boost::arg<2>, false));
    uiInterface.NotifyHeaderTip.connect(boost::bind(BlockTipChanged, this, boost::arg<1>, boost::arg<2>, true));
}
...
void ClientModel::unsubscribeFromCoreSignals()
{
    ...
    uiInterface.NotifyBlockTip.disconnect(boost::bind(BlockTipChanged, this, boost::arg<1>, boost::arg<2>, false));
    uiInterface.NotifyHeaderTip.disconnect(boost::bind(BlockTipChanged, this, boost::arg<1>, boost::arg<2>, true));
}
