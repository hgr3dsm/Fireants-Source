...
const QString BITCOIN_IPC_PREFIX("fireants:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/fireants-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/fireants-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/fireants-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click fireants: links
...
//
// OSX-specific way of handling fireants: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in fireants: URIs
