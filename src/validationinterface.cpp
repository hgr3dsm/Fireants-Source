...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.SyncTransaction.connect(boost::bind(&CValidationInterface::SyncTransaction, pwalletIn, boost::arg<1>, boost::arg<2>, boost::arg<3>));
    ...
    g_signals.Broadcast.connect(boost::bind(&CValidationInterface::ResendWalletTransactions, pwalletIn, boost::arg<1>));
...
void UnregisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.Broadcast.disconnect(boost::bind(&CValidationInterface::ResendWalletTransactions, pwalletIn, boost::arg<1>));
    ...
    g_signals.SyncTransaction.disconnect(boost::bind(&CValidationInterface::SyncTransaction, pwalletIn, boost::arg<1>, boost::arg<2>, boost::arg<3>));
