...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"fireantsaddress\"\n"
            "\nReveals the private key corresponding to 'fireantsaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"fireantsaddress\"   (string, required) The fireants address for the private key\n"
            "\nResult:\n"
